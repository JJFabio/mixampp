...
function asitheme_after_setup_theme() {
    ...
    if (!get_theme_mod(ASITHEME_SLUG . '_content_set', false)) {
        ...
        set_theme_mod(ASITHEME_SLUG . '_button_color', CHILD_THEME_DEFAULTS[ASITHEME_SLUG . '_button_color']);
        set_theme_mod(ASITHEME_SLUG . '_button_background', CHILD_THEME_DEFAULTS[ASITHEME_SLUG . '_button_background']);
        set_theme_mod(ASITHEME_SLUG . '_button_border_color', CHILD_THEME_DEFAULTS[ASITHEME_SLUG . '_button_border_color']);
        set_theme_mod(ASITHEME_SLUG . '_button_color_hover', CHILD_THEME_DEFAULTS[ASITHEME_SLUG . '_button_color_hover']);
        set_theme_mod(ASITHEME_SLUG . '_button_background_hover', CHILD_THEME_DEFAULTS[ASITHEME_SLUG . '_button_background_hover']);
        set_theme_mod(ASITHEME_SLUG . '_button_border_color_hover', CHILD_THEME_DEFAULTS[ASITHEME_SLUG . '_button_border_color_hover']);
        set_theme_mod(ASITHEME_SLUG . '_link_color', CHILD_THEME_DEFAULTS[ASITHEME_SLUG . '_link_color']);
        set_theme_mod(ASITHEME_SLUG . '_footer_text', CHILD_THEME_DEFAULTS[ASITHEME_SLUG . '_footer_text']);
        set_theme_mod(ASITHEME_SLUG . '_header_position', CHILD_THEME_DEFAULTS[ASITHEME_SLUG . '_header_position']);
    }
}
...
function asitheme_wp_head() {
    ...
    $header_background = get_theme_mod(ASITHEME_SLUG . '_header_background', CHILD_THEME_DEFAULTS[ASITHEME_SLUG . '_header_background']);
