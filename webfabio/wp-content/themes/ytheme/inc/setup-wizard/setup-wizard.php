...
function asi_admin_redirects() {
    ...
    if (!get_option('asi_setup_wizard_launched_' . ASITHEME_SLUG)) {

        update_option('asi_setup_wizard_launched_' . ASITHEME_SLUG, 1);
...
function asi_setup_wizard_menu() {
    add_theme_page(__('Setup wizard', ASITHEME_SLUG), __('Setup wizard', ASITHEME_SLUG), 'manage_options', 'asi-setup', 'asi_setup_wizard_page');
}
