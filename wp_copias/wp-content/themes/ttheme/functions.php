...
function asitheme_after_setup_theme() {
    ...
    if (!get_theme_mod(ASITHEME_SLUG . '_content_set', false)) {
        ...
        set_theme_mod(ASITHEME_SLUG . '_button_background', '#2296f3');
        set_theme_mod(ASITHEME_SLUG . '_button_border_color', '#2296f3');
        set_theme_mod(ASITHEME_SLUG . '_button_color_hover', '#ffffff');
        set_theme_mod(ASITHEME_SLUG . '_button_background_hover', '#047fe2');
        set_theme_mod(ASITHEME_SLUG . '_button_border_color_hover', '#047fe2');
        set_theme_mod(ASITHEME_SLUG . '_link_color', '#000000');
...
function asitheme_wp_enqueue_scripts() {
    ...
    $content_font = get_theme_mod(ASITHEME_SLUG . '_font', 'Raleway:100,100i,200,200i,300,300i,400,400i,500,500i,600,600i,700,700i,800,800i,900,900i');
    ...
    wp_enqueue_style('swiper', ASITHEME_CDN . '/assets/js/swiper/css/swiper.min.css', array(), CHILD_THEME_VERSION);
    wp_enqueue_script('swiper', ASITHEME_CDN . '/assets/js/swiper/js/swiper.min.js', array('jquery'), CHILD_THEME_VERSION);
...
function asitheme_wp_head() {
    ...
    $boton_background = get_theme_mod(ASITHEME_SLUG . '_button_background', '#2296f3');
    $boton_border = get_theme_mod(ASITHEME_SLUG . '_button_border_color', '#2296f3');
    $boton_color_hover = get_theme_mod(ASITHEME_SLUG . '_button_color_hover', '#ffffff');
    $boton_background_hover = get_theme_mod(ASITHEME_SLUG . '_button_background_hover', '#047fe2');
    $boton_boder_hover = get_theme_mod(ASITHEME_SLUG . '_button_border_color_hover', '#047fe2');
    $link_color = get_theme_mod(ASITHEME_SLUG . '_link_color', '#000000');
    $font_customize = get_theme_mod(ASITHEME_SLUG . '_font', 'Raleway:100,100i,200,200i,300,300i,400,400i,500,500i,600,600i,700,700i,800,800i,900,900i');
