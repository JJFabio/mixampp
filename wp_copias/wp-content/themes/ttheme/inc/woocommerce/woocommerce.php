...
add_filter('get_search_form', 'asitheme_woocommerce_get_search_form');

function asitheme_woocommerce_get_search_form($form) {
    $form = str_replace('<input type="submit"', '<input type="hidden" name="post_type" value="product"><input type="submit"', $form);
    return $form;
}
