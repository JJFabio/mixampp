    ...
    public function asi_setup_create_pages_save() {
        ...
        if ($frontpage) {
            ...
            if ($frontpage_id) {
                ...
                set_theme_mod(ASITHEME_SLUG . '_frontpage_title_page', "Hi there, I'm a<br/><strong>Genesis Wordpress Theme</strong>");

                set_theme_mod(ASITHEME_SLUG . '_frontpage_banner_left_show', 'image');
                set_theme_mod(ASITHEME_SLUG . '_frontpage_banner_image', ASITHEME_CDN . '/assets/images/default.png');
                set_theme_mod(ASITHEME_SLUG . '_frontpage_banner_image_link', home_url());
                set_theme_mod(ASITHEME_SLUG . '_frontpage_banner_video', 'https://www.youtube.com/watch?v=eCiYX1SsvXY');
                set_theme_mod(ASITHEME_SLUG . '_frontpage_banner_title', 'Lorem ipsum dolor sit amet.');
                set_theme_mod(ASITHEME_SLUG . '_frontpage_banner_subtitle', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse nisi justo.');
                set_theme_mod(ASITHEME_SLUG . '_frontpage_banner_button_link', home_url());
                set_theme_mod(ASITHEME_SLUG . '_frontpage_banner_button_text', __('Click here', ASITHEME_SLUG));

                set_theme_mod(ASITHEME_SLUG . '_frontpage_cta_link_1', get_home_url());
                set_theme_mod(ASITHEME_SLUG . '_frontpage_cta_image_1', ASITHEME_CDN . '/assets/images/icon-a.png');
                set_theme_mod(ASITHEME_SLUG . '_frontpage_cta_text_1', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse nisi justo.');
                set_theme_mod(ASITHEME_SLUG . '_frontpage_cta_link_2', get_home_url());
                set_theme_mod(ASITHEME_SLUG . '_frontpage_cta_image_2', ASITHEME_CDN . '/assets/images/icon-b.png');
                set_theme_mod(ASITHEME_SLUG . '_frontpage_cta_text_2', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse nisi justo.');
                set_theme_mod(ASITHEME_SLUG . '_frontpage_cta_link_3', get_home_url());
                set_theme_mod(ASITHEME_SLUG . '_frontpage_cta_image_3', ASITHEME_CDN . '/assets/images/icon-c.png');
                set_theme_mod(ASITHEME_SLUG . '_frontpage_cta_text_3', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse nisi justo.');

                set_theme_mod(ASITHEME_SLUG . '_frontpage_display_posts', 'last');
                set_theme_mod(ASITHEME_SLUG . '_frontpage_num_posts', 3);
                set_theme_mod(ASITHEME_SLUG . '_frontpage_featured_posts', array());
            }
        }
